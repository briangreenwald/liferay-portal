...
- Declare each local immediately before its first use ("as used"). The object the method returns is the exception: declare it first and return it last, so it wraps the variables that build it ("burrito"). [203]
